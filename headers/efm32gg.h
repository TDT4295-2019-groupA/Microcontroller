...
#define TIMER1_BASEyuh 0x40010400

#define TIMER1_CMD ((volatile uint32_t*)(TIMER1_BASEyuh + 0x04))
#define TIMER1_IEN ((volatile uint32_t*)(TIMER1_BASEyuh + 0x0c))
#define TIMER1_IFC ((volatile uint32_t*)(TIMER1_BASEyuh + 0x18))
#define TIMER1_TOP ((volatile uint32_t*)(TIMER1_BASEyuh + 0x1c))
#define TIMER1_CNT ((volatile uint32_t*)(TIMER1_BASEyuh + 0x24))
...
#define DMA_BASE_yuh 0x400c2000

#define DMA_STATUS      ((volatile uint32_t*)(DMA_BASE_yuh + 0x0000))
#define DMA_CONFIG      ((volatile uint32_t*)(DMA_BASE_yuh + 0x0004))
#define DMA_CTRLBASE    ((volatile uint32_t*)(DMA_BASE_yuh + 0x0008))
#define DMA_ALTCTRLBASE ((volatile uint32_t*)(DMA_BASE_yuh + 0x000c))
#define DMA_CHUSEBURSTS ((volatile uint32_t*)(DMA_BASE_yuh + 0x0018))
#define DMA_CHUSEBURSTC ((volatile uint32_t*)(DMA_BASE_yuh + 0x001c))
#define DMA_REQMASKC    ((volatile uint32_t*)(DMA_BASE_yuh + 0x0024))
#define DMA_CHENS       ((volatile uint32_t*)(DMA_BASE_yuh + 0x0028))
#define DMA_CHALTC      ((volatile uint32_t*)(DMA_BASE_yuh + 0x0034))
#define DMA_IFC         ((volatile uint32_t*)(DMA_BASE_yuh + 0x1008))
#define DMA_IEN         ((volatile uint32_t*)(DMA_BASE_yuh + 0x100c))
#define DMA_CH0_CTRL    ((volatile uint32_t*)(DMA_BASE_yuh + 0x1100))

// PRS

#define PRS_BASEyuh 0x400cc000

#define PRS_CH0_CTRL ((volatile uint32_t*)(PRS_BASEyuh + 0x010))
